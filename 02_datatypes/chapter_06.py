...
print(f"First word of Chai description : {chai_description[0:8:1]}") #gives 8 characters from 0th index to 7th index. 1 after second colon means give each character without skipping any character.
